        ...
        <div class="nav-links">
            ...
            <div class="nav-link dropdown">
                ...
                <div class="dropdown-content">
                    <a href="./pages/dashboardBatch.php"><i class="fas fa-users"></i> Batch</a>
                    <a href="./pages/dashboardLecturer.php"><i class="fas fa-chalkboard-teacher"></i> Lecturer</a>
                    <a href="./pages/dashboardStudent.php"><i class="fas fa-user-graduate"></i> Student</a>
                    <a href="./pages/dashboardSubject.php"><i class="fas fa-book"></i> Subject</a>
