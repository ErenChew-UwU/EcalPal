from get_data import fetch_lecturer_availability, fetch_venue_availability
...
def calculate_fitness(genes):
    ...
    penalty = 0
    lecturer_avail = fetch_lecturer_availability()  # list of {lecturer_id, day, timeslot}
    venue_avail = fetch_venue_availability()        # list of {venue_id, day, timeslot}
